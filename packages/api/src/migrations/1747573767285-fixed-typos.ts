...
export class FixedTypos1747573767285 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" RENAME COLUMN "asigneeId" TO "assigneeId"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" RENAME COLUMN "assigneeId" TO "asigneeId"`);

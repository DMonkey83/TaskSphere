...
export class ExtraFields1747497648819 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "color" boolean, CONSTRAINT "UQ_6a9775008add570dc3e5a0bab7b" UNIQUE ("name"), CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "time_tracking" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "hours" double precision NOT NULL, "description" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "workDate" date NOT NULL, "taskId" uuid, "userId" uuid, CONSTRAINT "PK_47d84cfac233244d3924cfdac37" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tag_tasks_tasks" ("tagId" uuid NOT NULL, "tasksId" uuid NOT NULL, CONSTRAINT "PK_9d1a1455d91d36f9fc79059a21e" PRIMARY KEY ("tagId", "tasksId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "attachment" ADD CONSTRAINT "FK_611282e10752b2ecbd5c8525ab5" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "time_tracking" ADD CONSTRAINT "FK_d0dcb549fa1963cca98bccc257f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "time_tracking" DROP CONSTRAINT "FK_d0dcb549fa1963cca98bccc257f"`);

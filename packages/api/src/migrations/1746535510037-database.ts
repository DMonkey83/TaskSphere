...
export class Database1746535510037 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "project_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role" character varying NOT NULL, "userId" uuid, "projectId" uuid, CONSTRAINT "PK_0b2f46f804be4aea9234c78bcc9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('owner', 'admin', 'user', 'project_manager')`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_61c463cd40a985a0f1b8319a94a" FOREIGN KEY ("asigneeId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "documents" ADD CONSTRAINT "FK_fe6ebd6e679c0feee3a7ecc0354" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "account_invite" ADD CONSTRAINT "FK_5d1309556736623139fc8c0ccd8" FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "account_invite" DROP CONSTRAINT "FK_5d1309556736623139fc8c0ccd8"`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks" DROP CONSTRAINT "FK_61c463cd40a985a0f1b8319a94a"`);
